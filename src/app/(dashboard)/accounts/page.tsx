...
export default async function AccountsPage() {
  ...
  const serialized = accounts.map(acct => ({
    ...
    balanceSource: acct.balanceSource,
    lastReconciled: acct.lastReconciled ? acct.lastReconciled.toISOString() : null,
    reconciliationDiscrepancy: acct.reconciliationDiscrepancy,
